...
export function SocialWall() {
  return (
    <section id="join" className="relative bg-green-alt/30 py-20 md:py-28 overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute top-10 left-[5%] w-24 h-24 blob-1 bg-signal-deep/15 float-slow" />
