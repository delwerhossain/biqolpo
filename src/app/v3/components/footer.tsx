        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-6 md:col-span-2">
            ...
            <ul className="space-y-3 text-[0.98rem]">
              ...
              <li><a href="/v2" className="hover:text-signal transition-colors">v2 (purple)</a></li>
              <li><a href="/v3" className="hover:text-signal transition-colors">v3 (current)</a></li>
              <li><a href="/v4" className="hover:text-signal transition-colors">v4 (clean)</a></li>
            </ul>
          </div>
