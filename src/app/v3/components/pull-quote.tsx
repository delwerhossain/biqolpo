...
export function PullQuote() {
  return (
    <section className="relative bg-signal-deep text-paper overflow-hidden py-20 md:py-28">
      <div className="pointer-events-none absolute inset-0 -z-0">
        <div className="absolute -top-10 -left-10 w-72 h-72 blob-1 bg-green-alt/20" />
