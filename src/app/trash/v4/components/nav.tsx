...
const LINKS = [
  { label: "Categories", href: "/v4#categories" },
  { label: "Trending", href: "/v4#featured" },
  { label: "How", href: "/v4#how" },
  { label: "Submit", href: "/v4#submit" },
];
  ...
  return (
    <header className="sticky top-0 z-40 bg-cream/90 backdrop-blur-md border-b border-border-soft">
      <div className="mx-auto max-w-[1180px] px-5 md:px-10 h-16 flex items-center justify-between">
        <Link href="/v4" aria-label="Biqolpo home" className="flex items-center">
          <Logo size="md" />
        </Link>
